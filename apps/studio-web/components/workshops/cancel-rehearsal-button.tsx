  ...
  return (
    <>
      <button
        ...
        aria-label={t.workshops.cancelRehearsalButton.ariaLabel}
        title={t.workshops.cancelRehearsalButton.ariaLabel}
      ...
      >
        <div className="w-full max-w-sm rounded-xl border border-ink-foreground/16 bg-ink-card p-6 text-ink-foreground">
          <p className="text-lg font-semibold">{t.workshops.cancelRehearsalButton.confirmTitle}</p>
          <p className="mt-1 text-sm text-ink-foreground/60">{t.workshops.cancelRehearsalButton.confirmBody}</p>
